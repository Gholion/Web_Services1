...
{
  var numgames = 'SELECT * from football_games;';
...
app.get('/player_info', function(req, res) {
  var query = 'SELECT id, names FROM football_players;';
  db.any(query)
        .then(function (rows) {
...
{
  var curr_player = req.query.player_selection
  var idnames = 'SELECT id,names from football_players;';
  var currinfo = 'Select * FROM football_players WHERE id = curr_player';
  var totgames = 'Select COUNT(*)  from football_players fp join football_games fg on fp.id=curr_player;';
  db.task('get-everything', task => {
      return task.batch([
          task.any(idnames),
          task.any(currinfo),
